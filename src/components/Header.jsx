  ...
  return (
    <header className={`site-header${isScrolled ? ' scrolled' : ''}`}>
      <div className="header-container">
        <a href={isHomePage ? "#home" : "/"} className="header-logo" onClick={closeMenu}>
        ...
        <nav className={`main-nav${isMenuOpen ? ' active' : ''}`} id="mainNav">
          ...
          <a href={isHomePage ? "#contact" : "/#contact"} className="header-cta" onClick={closeMenu}>
